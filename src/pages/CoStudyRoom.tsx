    ...
    <div className="flex flex-col h-[calc(100vh-80px)] p-4 md:p-8 space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-8 flex-1">
        <div className="md:col-span-2 glass rounded-3xl p-6 md:p-12 flex flex-col items-center justify-center relative overflow-hidden group">
           ...
           <div className="absolute top-6 left-6 z-20 flex items-center gap-2 bg-white/50 dark:bg-zinc-900/50 p-2 rounded-xl border border-stone-200 dark:border-zinc-800 shadow-sm backdrop-blur-md">
           ...
           <AnimatePresence>
             {showChecklist && (
                <motion.div 
                   ...
                   className="absolute top-20 right-6 z-30 w-72 bg-white dark:bg-zinc-900 border border-stone-200 dark:border-zinc-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[60vh]"
                >
                ...
                {(activeUsers || []).map((user, idx) => {
                   ...
                   >
                      <div className="flex items-center gap-3">
                         <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-amber-400 to-yellow-600 flex items-center justify-center text-white font-bold uppercase shadow-sm shrink-0">
